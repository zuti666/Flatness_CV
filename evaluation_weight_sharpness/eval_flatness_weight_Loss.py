...
from evaluation_weight_sharpness.power_iter import (
    _power_iteration_generic,
    _power_iteration_lambda_max,
)
from evaluation_weight_sharpness.lanczos_iter import (
    _lanczos_lambda_max,
    _lanczos_lambda_max_generic,
    _lanczos_topk_generic,
)
from evaluation_weight_sharpness.param_utils import (
...
from evaluation_weight_sharpness.loss_utils import (
    _compute_loss,
...
from evaluation_weight_sharpness.io_utils import (
    _load_args,
    _save_eigvecs,
)
from evaluation_weight_sharpness.curv_localization import (
...
class FlatnessConfig:
    ...
    loss_land_modes: str = "all"             # "lora" | "full" | "all"
    ...
    eval_expected_sharpness: bool = False # compute grad-based sharpness (E-Sh)
    eval_hessian: bool = False    # compute Hessian spectral metrics
    eval_ggn: bool = False        # compute GGN spectral metrics
    eval_fisher: bool = False      # compute empirical Fisher metrics
...
def evaluate_flatness_metrics(
    ...
    try:
        ...
        if bool(getattr(config, "eval_fisher", False)):
