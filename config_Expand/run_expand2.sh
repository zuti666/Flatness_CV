...
CONFIGS=(
  config_Expand/as1_normfisher_lam2000_cifar100_t10c10_r10_sgd_lr002_e20_rho005_f100.yaml
  config_Expand/as1_normfisher_lam2000_imagenetr_t10c20_r10_sgd_lr002_e50_rho005_f100.yaml
...
for i in "${!CONFIGS[@]}"; do
  ...
  if [[ "$cfg_entry" = /* ]]; then
    cfg="$cfg_entry"
  elif [[ "$cfg_entry" == config_Expand/* ]]; then
    cfg="$ROOT/$cfg_entry"
  else
    cfg="$CONFIG_DIR/$cfg_entry"
  fi
