...
class Learner(BaseLearner):
    ...
    def incremental_train(self, data_manager):
        ...
        try:
            ...
            logging.exception("[RWP_GAUSS] Failed to compute class means: %s", exc)
    ...
    def _store_directions(self, loader, model: nn.Module):
        ...
        logger.info("[RWP_GAUSS] Stored %d directions (cap %d)", len(self._directions), self._ogd_max_dirs)
    ...
    def _align_directions_to_dim(self, target_dim: int) -> None:
        ...
        logger.info("[RWP_GAUSS] Aligned %d directions to dim=%d", len(self._directions), target_dim)
